          ...
          >
            <CardHeader className='flex flex-row items-start justify-between gap-4 pb-4'>
              <div>
                ...
                <CardDescription className='mt-2 text-sm'>{trip.summary}</CardDescription>
              </div>
              <Badge
                className={cn(
            ...
            <CardContent className='space-y-5'>
              ...
              <div className='grid gap-3 sm:grid-cols-2'>
                <div className='rounded-2xl border border-border/60 bg-background/60 p-4'>
                  <p className='text-muted-foreground text-xs uppercase tracking-[0.24em]'>Style</p>
                  <p className='mt-2 font-medium'>{trip.style}</p>
                </div>
                <div className='rounded-2xl border border-border/60 bg-background/60 p-4'>
                  <p className='text-muted-foreground text-xs uppercase tracking-[0.24em]'>Focus</p>
